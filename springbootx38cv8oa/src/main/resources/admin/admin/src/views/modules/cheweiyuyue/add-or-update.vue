	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info' && !ro.chepaihao" label="车牌号" prop="chepaihao">
					<file-upload
						tip="点击上传车牌号"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-else-if="ruleForm.chepaihao" label="车牌号" prop="chepaihao">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.chepaihao.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="车辆状态" prop="cheliangzhuangtai">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="车辆状态" prop="cheliangzhuangtai">
					<el-input v-model="ruleForm.cheliangzhuangtai"
						placeholder="车辆状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="入场时间" prop="ruchangshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.ruchangshijian" label="入场时间" prop="ruchangshijian">
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.cheliangzhuangtai = '未出校'; 			}
			// 获取用户信息
			this.$http({
	...
	if(this.ruleForm.chepaihao!=null) {
		this.ruleForm.chepaihao = this.ruleForm.chepaihao.replace(new RegExp(this.$base.url,"g"),"");
	}
var objcross = this.$storage.getObj('crossObj');
    ...
    chepaihaoUploadChange(fileUrls) {
	    this.ruleForm.chepaihao = fileUrls;
    },
  }
};
</script>
