	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.cheweibianhao" label="车位编号" prop="cheweibianhao">
					<el-input v-model="ruleForm.cheweibianhao" placeholder="车位编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="校门信息" prop="cheweileixing">
					<el-select :disabled="ro.cheweileixing" v-model="ruleForm.cheweileixing" placeholder="请选择校门信息" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="校门信息" prop="cheweileixing">
					<el-input v-model="ruleForm.cheweileixing"
						placeholder="校门信息" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="小时价格" prop="xiaoshijiage">
					<el-input-number v-model="ruleForm.xiaoshijiage" placeholder="小时价格" :readonly="ro.xiaoshijiage"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="小时价格" prop="xiaoshijiage">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="车位简介" prop="cheweijianjie">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.cheweijianjie" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.cheweijianjie" label="车位简介" prop="cheweijianjie">
                    <span :style='{"padding":"0 20px","color":"inherit","background":"none","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.cheweijianjie"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='cheweijianjie'){
							this.ruleForm.cheweijianjie = obj[o];
							this.ro.cheweijianjie = true;
							continue;
						}
						if(o=='thumbsupnum'){
				...
				this.ruleForm.cheweizhuangtai = '未停放'; 			}
			// 获取用户信息
			this.$http({
            ...
            this.cheweizhuangtaiOptions = "已停放,未停放".split(',')
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.cheweijianjie = this.ruleForm.cheweijianjie.replace(reg,'../../../springbootx38cv8oa/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
		if(this.ruleForm.cheweibianhao) {
			this.ruleForm.cheweibianhao = String(this.ruleForm.cheweibianhao)
		}
